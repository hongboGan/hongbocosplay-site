    ...
    <>
      <section className="hero">
        <div className="shell hero__inner">
          ...
          <p className="lede">
            Masks, headwear, wigs and armour-style outerwear for party-goods importers, cosplay retailers and event
            producers. Low minimums on stock lines, full OEM on your own artwork and sizing.
          </p>
